...
class TokenCounter:
    ...
    def count_message_tokens(messages: List[BaseMessage], model: str = "gpt-3.5-turbo-0301") -> int:
        ...
        """
        try:
            model_token_per_message_dict = {"gpt-3.5-turbo-0301": 4, "gpt-4-0314": 3, "gpt-3.5-turbo": 4, "gpt-4": 3,"gpt-3.5-turbo-16k":4, "gpt-4-32k": 3, "gpt-4-32k-0314": 3, "models/chat-bison-001": 4, "local": 4}
        	if model == 'local':
                model = "gpt-3.5-turbo"
